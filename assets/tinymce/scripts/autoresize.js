// custom version implementing autoresize_grow_only

tinymce.PluginManager.add('jobadder_autoresize', function (editor) {
  ...
  function resize(e) {
    ...
    // Custom autoresize_grow_only implementation
    if ((!settings.autoresize_grow_only && resizeHeight !== oldSize)
      || (settings.autoresize_grow_only && resizeHeight > oldSize)) {
      ...
      if (tinymce.Env.webKit && deltaSize < 0) {
        resize(e);
      }
    }
  }
  ...
  // Custom autoresize_grow_only implementation
  settings.autoresize_grow_only = !!editor.getParam('autoresize_grow_only', false);
  ...
  // Custom autoresize_grow_only implementation
  editor.on("nodechange setcontent paste keyup", resize);
